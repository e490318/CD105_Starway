...
<body>
        ...
        <section class="mainBar">
            ...
            <nav>
                <ul class="menu">
                    ...
                    <li class="login_mobile"><a onclick="checkToUser()" class="menu_items " style="cursor: pointer;"><i class="fas fa-user"></i></a></li>
        ...
        <div class="section A-record">
            <div class="width1200 A-page1st A-albumArea">
                ...
                <div class="A-textarea">
                    <form class="textform" method="post" accept-charset="utf-8" name="form1">
                        <h4>姓名</h4>
                        <input type="text" id="cuUserName" class="cuWriteContent" name="cuuserName" value='<?php 
                ...
                <div class="cuWriteConfirm">
                    <h3 class="cuWriteTitle">請確認欲上架之專輯內容</h3>
                        ...
                        <a id="custImgDownload" href="images/cd104.png" download><span>&nbsp;下載圖片</span></a>
                ...
                <div class="cuWriteConfirmButtons">
                        ...
                        <button id="A-nextButton" type="submit" id='sendForm'>專輯上架</button>
                </div>	
    ...
    $(document).ready(function(){
        ...
        $('.cuNext4').on('click', function(e){
            ...
            $('.cuWriteAlbumTitle').html(storage['UserAlbumTitle']);
            $('.cuWriteContent').html(storage['UserContent']);

            //******** 將所輸入的欄位放到訂單明細資料確認 ********
            $('.cuWriteName').text(payMethod);
            $('.cuWriteAlbumTitle').text(customerName);
            $('.cuWriteContent').text(customerContact);
            }
        });
    });	
    // 點擊步驟三下一步觸發事件 end
