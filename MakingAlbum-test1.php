            ...
            <div class="width1200 A-page1st">
                ...
                <div class="A-albumAll">
                    <div class="A-centerBox">
                        <div id="dropZone" class="A-box img">
                                ...
                                <div class="content__wrapper A-bgBox">
                                    ...
                                    <div class="A-bgBox1">
                                        ...
                                        <label for="mobfileUpload">
                                            ...
                                            <!-- <input type="file" id="theFile onchange="readURL(this)" targetID="preview_progressbarTW_img" accept="image/gif, image/jpeg, image/png"/ ><img
                                            src="images/Record/newbg.png"> -->
                                        ...
                                        <img src="images/Record/small/M1_SP_001.jpg" class="small" alt="small">
                                        <img src="images/Record/small/M1_SP_002.jpg" class="small" alt="small">
                                ...
                                <div class="content__wrapper A-rightCont">
                                    ...
                                    <div class="A-iconImg">
                                        <div id="imgBox" class="A-iconbg">
                                            <img src="images/Record/icon1.svg" class="img" id="img0" alt="icon">
                                            <img src="images/Record/icon2.svg" class="img" id="img1" alt="icon">
                                            <img src="images/Record/icon3.svg" class="img" id="img2" alt="icon">
                                            <img src="images/Record/icon4.svg" class="img" id="img3" alt="icon">
                                            <img src="images/Record/icon5.svg" class="img" id="img4" alt="icon">
                                            <img src="images/Record/icon6.svg" class="img" id="img5" alt="icon">
                                            <img src="images/Record/icon7.svg" class="img" id="img6" alt="icon">
                                            <img src="images/Record/icon8.svg" class="img" id="img7" alt="icon">
                                            <img src="images/Record/icon9.svg" class="img" id="img8" alt="icon">
                                            <img src="images/Record/icon10.svg" class="img" id="img9" alt="icon">
                                            <img src="images/Record/icon11.svg" class="img" id="img10" alt="icon">
                                            <img src="images/Record/icon12.svg" class="img" id="img11" alt="icon">
                                            <img src="images/Record/icon9.svg" class="img" id="img8" alt="icon">
                                            <img src="images/Record/icon10.svg" class="img" id="img9" alt="icon">
                                            <img src="images/Record/icon11.svg" class="img" id="img10" alt="icon">
                                            <img src="images/Record/icon9.svg" class="img" id="img8" alt="icon">
                                        ...
                                        <div id="btns">
                                            ...
                                            <!-- <button id="big">big</button>
                                                    ...
                                                    <button id="rotate">turn right</button>
                                                    <button id="reverse">turn left</button>
                ...
                <form action="MakingAlbum2.php" method="post">
                    ...
                    <p><input id="A-nextButton" type="submit" value="登入"></p>
                </form>
            </div>
        </div>
    </section>
